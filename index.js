...
function filterUnfundedOnly() {
    ...
    // console.log(unfundedGames.length);  7 games
}
...
function filterFundedOnly() {
    ...
    // console.log(fundedGames.length); 4 games
}
...
const singleGame = () => {unfundedGames == 1 ? true : false}
// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `A total of ${totalAmountRaised} has been raised for ${totalGames}.
                    Currently, ${singleGame() ? unfundedGames + " game " : unfundedGames + " games "}
                    remain${singleGame() ? "":"s"} unfunded. We need your help to fund ${singleGame() ? "this amazing game!": "these amazing games!"}`;
